...
할머니는 의미심장한 미소를 지으며 톰과 제리에게 말을 걸었다.
...
너무 어두워서 할머니의 얼굴은 잘 보이지 않았지만, 상당히 익숙한 형태였다.
...
```
주머니는 쉽게 열리지 않도록 단단히 묶여있었다.
톰은 주머니 안에 어떤 것이 들어있는지 알 수 없지만, 무언가 묵직한 것이 들어 있는 듯한 느낌은 확실했다.
그래도 주머니가 예쁘장해서 톰은 마음에 들었다.
